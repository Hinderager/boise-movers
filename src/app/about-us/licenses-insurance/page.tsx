...
export const metadata: Metadata = {
  title: 'Licenses & Insurance | Boise Movers Pros',
  description: 'Licenses & Insurance - Boise Movers Pros. Serving the Treasure Valley.',
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p>Content for Licenses & Insurance coming soon.</p>
          </div>
        </div>
      </section>
