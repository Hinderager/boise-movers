...
export const metadata: Metadata = {
  title: 'About Us | Boise Movers Pros',
  description: 'Learn about Boise Movers Pros. Local moving experts serving the Treasure Valley. Licensed, insured, and committed to quality service.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About Boise Movers Pros</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Your trusted local moving experts in the Treasure Valley.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Boise Movers Pros is a locally owned and operated moving company serving homeowners and businesses throughout the Treasure Valley. We provide complete moving services including local moves, long distance relocations, packing services, furniture moving, and loading/unloading assistance.</p>
              <p>Our team of professional movers is committed to providing honest, reliable service at fair prices. We believe in treating your belongings with care and making your move as stress-free as possible.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">Fully licensed moving company with comprehensive insurance coverage.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">We stand behind our work and handle your belongings with care.</p>
              </div>
              <div className="text-center">
