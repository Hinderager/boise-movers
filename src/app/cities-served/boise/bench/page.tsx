...
export const metadata: Metadata = {
  title: 'Moving The Bench Boise | Top Shelf',
  description: 'Moving services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['moving The Bench', 'moving The Bench Boise', 'The Bench boise moving'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need moving services in the The Bench area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Moving in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Moving to or from the Bench? The neighborhood's central location means shorter trips to most Boise destinations. We know the best routes and can handle moves of any size, from apartments to large family homes.</p>
                <p>
