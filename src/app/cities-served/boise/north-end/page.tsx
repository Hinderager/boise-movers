...
export const metadata: Metadata = {
  title: 'Moving North End Boise | Top Shelf',
  description: 'Moving services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['moving North End', 'moving North End Boise', 'North End boise moving'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for moving in North End? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Moving in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Moving into or out of a North End home? The narrow streets, mature trees, and historic architecture require experienced movers who know how to navigate tight spaces without damaging your belongings or the property.</p>
                <p>
