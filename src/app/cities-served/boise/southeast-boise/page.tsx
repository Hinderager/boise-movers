...
export const metadata: Metadata = {
  title: 'Moving Southeast Boise Boise | Top Shelf',
  description: 'Moving services in Southeast Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['moving Southeast Boise', 'moving Southeast Boise Boise', 'Southeast Boise boise moving'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/boise/southeast-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Moving in Southeast Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need moving services in the Southeast Boise area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Moving in Southeast Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Southeast Boise's convenient location makes it a popular choice for families and professionals. We help people move in and out of the area efficiently.</p>
                <p>
