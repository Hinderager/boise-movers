...
export const metadata: Metadata = {
  title: 'Moving Ten Mile Area Meridian | Top Shelf',
  description: 'Moving services in Ten Mile Area, Meridian, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['moving Ten Mile Area', 'moving Ten Mile Area Meridian', 'Ten Mile Area meridian moving'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/meridian/ten-mile',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Moving in Ten Mile Area
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Ten Mile Area with professional moving services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Moving in Ten Mile Area, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Moving to Ten Mile? You're joining one of Meridian's most popular areas. We'll help you get settled in your new home quickly and efficiently.</p>
                <p>
