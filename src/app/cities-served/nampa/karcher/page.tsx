...
export const metadata: Metadata = {
  title: 'Moving Karcher Nampa | Top Shelf',
  description: 'Moving services in Karcher, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['moving Karcher', 'moving Karcher Nampa', 'Karcher nampa moving'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/nampa/karcher',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Karcher with professional moving services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Moving in Karcher, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Moving to the Karcher area? Great freeway access and plenty of amenities. We'll help you get settled.</p>
                <p>
