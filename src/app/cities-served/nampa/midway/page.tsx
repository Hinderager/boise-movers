...
export const metadata: Metadata = {
  title: 'Moving Midway Nampa | Top Shelf',
  description: 'Moving services in Midway, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['moving Midway', 'moving Midway Nampa', 'Midway nampa moving'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/nampa/midway',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Midway residents trust us for moving. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Moving in Midway, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Moving to one of Midway's new subdivisions? We'll help you get settled in your new Nampa home.</p>
                <p>
