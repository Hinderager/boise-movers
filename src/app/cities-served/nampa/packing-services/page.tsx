...
export const metadata: Metadata = {
  title: 'Packing Services Nampa ID | Boise Movers',
  description: 'Professional packing services in Nampa, Idaho. Fast, careful service at fair prices. Licensed & insured. Call (208) 768-3987.',
  keywords: ['packing services Nampa', 'movers Nampa Idaho', 'moving services Nampa'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/nampa/packing-services',
  },
}
...
export default function NampaPackingServicesPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/packing-services.webp"
          alt="Packing Services in Nampa, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Packing Services in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Expert packing and unpacking for Nampa residents. Professional, reliable, stress-free.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Packing Services Services in Nampa</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need packing services in Nampa? We make moving simple. You've got enough to worry about - let us handle the heavy lifting.</p>
              <p>Our crew has helped hundreds of Nampa families with packing services. We show up on time, work efficiently, and treat your belongings with care.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Packing Services in Nampa?</h3>
