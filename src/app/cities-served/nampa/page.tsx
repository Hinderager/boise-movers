...
export const metadata: Metadata = {
  ...
  description: 'Professional movers in Nampa, Idaho. Local and long-distance moves, packing, loading help. Licensed & insured. Call (208) 768-3987.',
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h3 className="text-2xl font-bold text-dark-blue mb-6">Nampa Areas We Serve</h3>
