...
export default function StarApartmentMovingPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/apartment-moving.webp"
          alt="Apartment Moving in Star, Idaho"
          fill
          priority
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Apartment Moving Services in Star</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need apartment moving in Star? We make moving simple. You've got enough to worry about - let us handle the heavy lifting.</p>
              <p>Our crew has helped hundreds of Star families with apartment moving. We show up on time, work efficiently, and treat your belongings with care.</p>
            </div>
