...
export const metadata: Metadata = {
  ...
  description: 'Professional moving services in Boise and the Treasure Valley. Local moving, packing services, loading/unloading, and specialty moves. Call (208) 768-3987.',
