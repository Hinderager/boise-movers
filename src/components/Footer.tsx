      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services/local-moving" className="text-white/80 hover:text-white transition-colors">Local Moving</Link></li>
              <li><Link href="/services/long-distance" className="text-white/80 hover:text-white transition-colors">Long Distance</Link></li>
              <li><Link href="/services/packing" className="text-white/80 hover:text-white transition-colors">Packing Services</Link></li>
              <li><Link href="/services/loading-unloading" className="text-white/80 hover:text-white transition-colors">Loading/Unloading</Link></li>
              <li><Link href="/services/specialty/furniture" className="text-white/80 hover:text-white transition-colors">Furniture Moving</Link></li>
              <li><Link href="/services/specialty/senior" className="text-white/80 hover:text-white transition-colors">Senior Moving</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-white/80">Mon-Sat: 7am - 7pm<br />Sunday: 8am - 5pm</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm">&copy; {new Date().getFullYear()} Boise Movers Pros. All rights reserved.</p>
